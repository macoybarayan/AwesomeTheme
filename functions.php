...
function awesome_theme_scripts() {
	...
	wp_enqueue_style( 'awesome_theme-din-style', get_template_directory_uri() . '/assets/css/DIN.css' );
...
add_action( 'init', 'custom_event_tax', 0 );

// Register Custom Post Type
function custom_course() {
...
add_action( 'init', 'custom_course', 0 );


// Register Custom Taxonomy
function custom_course_tax() {

	$labels = array(
		'name'                       => _x( 'Course Categories', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Course Category', 'Taxonomy Singular Name', 'text_domain' ),
...
add_action( 'init', 'custom_course_tax', 0 );